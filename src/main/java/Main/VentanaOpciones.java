...
public class VentanaOpciones extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Escoge un nivel de dificultad");

        jLabel2.setIcon(iconoDGT);
 ...
 // Declaro aquí la imágen usada en la ventana
    ImageIcon imagenDGT = new ImageIcon("src/images/dgt.png");
    Icon iconoDGT = new ImageIcon(imagenDGT.getImage());
